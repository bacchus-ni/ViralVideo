...
![模板视频解析演示](docs/videos/02-template-analysis.gif)
...
![文案与分镜生成演示](docs/videos/03-generate-scripts-and-storyboards.gif)
...
![分镜高级设置演示](docs/videos/03-shot-customization.gif)
...
![音乐设置演示](docs/videos/09-music-settings.gif)
...
![视频生成与导出演示](docs/videos/04-render-export.gif)
